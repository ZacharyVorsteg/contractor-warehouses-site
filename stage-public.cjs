...
const entries = ["blog", "cef0752662da2ce0eb360708188259db.txt", "favicon.ico", "googlea09d70eb2ac56a46.html", "images", "index.html", "llms-full.txt", "llms.txt", "robots.txt", "sitemap.xml", "thank-you.html", "warehouse-audio.wav"];
